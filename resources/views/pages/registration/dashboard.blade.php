    ...
    <div class="container-fluid">
        ...
        @else
            ...
            <div class="card mb-4">
                ...
                <div class="card-body">
                    <p class="mb-2">
                        Please read the full official competition rules and judging criteria before submitting your
                        registration.
                    </p>
                    <a href="{{ asset('public/storage/rules_ftb2025.pdf') }}" class="btn btn-outline-dark btn-sm"
                        target="_blank">
