                        ...
                        <div class="card shadow mb-4">
                            ...
                            <div class="card-body p-4"
                                ...
                                <p>
                                    ...
                                    (universiti / Kolej Universiti / Kolej / Institusi Perguruan / Politeknik / Kolej
                                    Komuniti)
                                ...
                                <ol>
                                    <li>Kami akan mematuhi setiap peraturan dan syarat seperti yang ditetapkan oleh pihak
                                        Jawatankuasa Penganjur sepanjang berlangsungnya Festival Tari Borneo IX (Edisi Ke-9)
                                        2025.</li>
                            ...
                            <div class="card-body p-4">
                                <form method="POST" action="{{ route('register.store') }}" enctype="multipart/form-data">
                                    ...
                                    <div class="text-center mt-3">
                                        <p class="mb-0">Sudah ada akaun? <a href="{{ route('login') }}">Log Masuk</a>
                                        </p>
                                    </div>
                                </form>
                            </div>
